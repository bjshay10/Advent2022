...
function moveCrate(amnt, src, dest) {
    ...
    for(a=0; a<amnt; a++){
        ...
        //add item to dest
        if (parseInt(dest) === 1) {
            crateArray1.push(tempItm)
        } else if (parseInt(dest) === 2) {
            crateArray2.push(tempItm)
        } else if (parseInt(dest) === 3) {
            crateArray3.push(tempItm)
        } else if (parseInt(dest) === 4) {
            crateArray4.push(tempItm)
        } else if (parseInt(dest) === 5) {
            crateArray5.push(tempItm)
        } else if (parseInt(dest) === 6) {
            crateArray6.push(tempItm)
        } else if (parseInt(dest) === 7) {
            crateArray7.push(tempItm)
        } else if (parseInt(dest) === 8) {
            crateArray8.push(tempItm)
        } else if (parseInt(dest) === 9) {
            crateArray9.push(tempItm)
        }
    }
}
